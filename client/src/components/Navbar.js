...
export default function Navbar() {
  ...
  return (
    ...
    <div className="container-fluid">
      <Link className="navbar-brand fs-1" to="/" style={{fontFamily:"Cormorant Garamond, serif"}}>

    H<span className="fst-italic fs-3">omely</span>E<span className="fst-italic fs-3">ats</span>
